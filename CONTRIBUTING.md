...
`backstage-plugin-codemods` is [MIT licensed](LICENSE) and accepts contributions via
...
- GitHub [issues](https://github.com/K-Phoen/backstage-plugin-codemods/issues)
...
```
git clone git@github.com:your_github_username/backstage-plugin-codemods.git
cd backstage-plugin-codemods
git remote add upstream https://github.com/K-Phoen/backstage-plugin-codemods.git
git fetch upstream
```
...
[fork]: https://github.com/K-Phoen/backstage-plugin-codemods/fork
